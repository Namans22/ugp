...
def update_image():
    ...
    result = relight(albedo_img.copy(), normal_img.copy(), lx, ly, lz, light_color)
...
# Split GUI into left (image) and right (controls)
